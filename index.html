				...
				<header class="archive-header-blog">
					<div class="container">
						<p class="archive-header-blog-title">
							OpentTalent - <strong>Actualidad</strong>
						</p>
					</div>
				</header>
					...
					<div class="cards">
						<div class="container">
							<div class="cards-filters">
								<button class="btn_filtros">
									<span>Categorías</span>
									<span class="svg svg-caret-down">
										<svg width="8" height="4">
											<use xlink:href="https://accordproject.org/wp-content/themes/accord-project/static/assets/spritesheet.svg#caret-down"></use> 
										</svg>
									</span>
								</button>
